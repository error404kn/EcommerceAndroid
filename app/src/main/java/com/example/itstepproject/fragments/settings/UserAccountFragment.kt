...
import com.example.itstepproject.databinding.FragmentUserAccountBinding
import com.example.itstepproject.dialog.setupBottomSheetDialog
import com.example.itstepproject.util.Resource
import com.example.itstepproject.viewmodel.UserAccountViewModel
...
class UserAccountFragment: Fragment() {
    ...
    private fun showUserInformation(data: User) {
        binding.apply {
            ...
            edFirstName.setText(data.firtstName)
