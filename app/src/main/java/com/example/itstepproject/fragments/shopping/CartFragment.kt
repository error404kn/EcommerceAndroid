...
import com.example.itstepproject.adapters.CartProductAdapter
import com.example.itstepproject.databinding.FragmentCartBinding
import com.example.itstepproject.firebase.FirebaseCommon
import com.example.itstepproject.util.Resource
import com.example.itstepproject.util.VerticalItemDecoration
import com.example.itstepproject.viewmodel.CartViewModel
        ...
        viewLifecycleOwner.lifecycleScope.launch{
            viewModel.deleteDialog.collectLatest {
                val alertDialog = AlertDialog.Builder(requireContext()).apply {
                    ...
                    setMessage("ნამდვილად გსურთ ამ პროდუქტის წაშლა კალათიდან?")
