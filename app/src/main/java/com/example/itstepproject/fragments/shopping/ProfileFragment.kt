...
import com.example.itstepproject.activities.LoginRegisterActivity
import com.example.itstepproject.databinding.FragmentProfileBinding
import com.example.itstepproject.util.Resource
import com.example.itstepproject.util.showBottomNavigationView
import com.example.itstepproject.viewmodel.ProfileViewModel
            ...
            viewModel.user.collectLatest {
                when(it){
                    ...
                    is Resource.Success -> {
                        ...
                        binding.tvUserName.text = "${it.data.firtstName} ${it.data.lastName}"
                    }
                    is Resource.Error -> {
